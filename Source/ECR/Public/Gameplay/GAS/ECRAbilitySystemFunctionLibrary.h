...
public:
	...
	UFUNCTION(BlueprintPure, Category = "GameplayCue")
	static FGameplayCueParameters MakeGameplayCueParametersFromHitResultIncludingSourceAndCauser(
	...
	UFUNCTION(BlueprintPure)
	static FECRGameplayModifierInfoWrapper ExtractGameplayModifierInfoFromExecution(
	...
	UFUNCTION(BlueprintCallable, Category = "Ability|GameplayAbility",
		Meta = (DisplayName = "Get GameplayAbility UI Data", DeterminesOutputType="DataType"))
	static const UGameplayEffectUIData* GetGameplayAbilityUIData(TSubclassOf<UECRGameplayAbility> AbilityClass,
	...
	static void GetAllParticleSystemsFromCues(TSet<UParticleSystem*>& OutParticlesBurst,
